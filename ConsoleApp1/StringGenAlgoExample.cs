...
namespace StringGenAlgoConsole
{
    internal class StringGenAlgoExample
    {
        public void GenerateStringsFromRegex()
        {
            ...
            var sample = rexEngine.GenerateTestStrings(RegexOptions.None, regexes: regexes);
            //Console.WriteLine();
            ...
            using (StreamWriter outputFile = new StreamWriter(Path.Combine(docPath, "genStrings.txt")))
            {
